...
public:
  ...
  class  ErrorExprContext : public ExprContext {
  public:
    ErrorExprContext(ExprContext *ctx);
  ...
  class  GtExprContext : public ExprContext {
  public:
    GtExprContext(ExprContext *ctx);
  ...
  class  GteExprContext : public ExprContext {
  public:
    GteExprContext(ExprContext *ctx);
  ...
  class  LteExprContext : public ExprContext {
  public:
    LteExprContext(ExprContext *ctx);
  ...
  class  LtExprContext : public ExprContext {
  public:
    LtExprContext(ExprContext *ctx);
  ...
  class  CellRefExprContext : public ExprContext {
  public:
    CellRefExprContext(ExprContext *ctx);

    antlr4::tree::TerminalNode *CELL_REF();
    virtual void enterRule(antlr4::tree::ParseTreeListener *listener) override;
    virtual void exitRule(antlr4::tree::ParseTreeListener *listener) override;
